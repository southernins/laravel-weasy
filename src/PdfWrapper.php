...
namespace SouthernIns\LaravelWeasy;

use Illuminate\Http\Response;
use Pontedilana\PhpWeasyPrint\Pdf as WeasyPrint;
use Illuminate\Support\Facades\View;
use Illuminate\Contracts\Support\Renderable;
use Symfony\Component\HttpFoundation\StreamedResponse;

/**
 * A Laravel wrapper for WeasyPrint
 *
 * @package laravel-weasy
 */
class PdfWrapper{
    ...
    /**
     * @param \Pontedilana\PhpWeasyPrint\Pdf $weasy
     */
    public function __construct(WeasyPrint $weasy)
    {
        $this->weasy = $weasy;
    }
